...
namespace EShop.Server.Migrations
{
    public partial class drop_old_seed_data : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "ProductVersions",
                columns: new[] { "ID", "Barcode", "Description", "Price", "ProductID", "PromotionPrice", "Quantum", "RemainingAmount", "SKU", "WareHouseID" },
                values: new object[] { 1, "COC", "Màu đỏ dl 250", 19000000m, 1, 0m, 100, 100, "Iphone test", 0 });

            migrationBuilder.InsertData(
                table: "ProductVersions",
                columns: new[] { "ID", "Barcode", "Description", "Price", "ProductID", "PromotionPrice", "Quantum", "RemainingAmount", "SKU", "WareHouseID" },
                values: new object[] { 2, "COC", "Màu xanh dl 250", 18000000m, 1, 0m, 100, 100, "Iphone test", 0 });

            migrationBuilder.InsertData(
                table: "ProductVersions",
                columns: new[] { "ID", "Barcode", "Description", "Price", "ProductID", "PromotionPrice", "Quantum", "RemainingAmount", "SKU", "WareHouseID" },
                values: new object[] { 3, "COC", "Màu xanh dl 250", 16000000m, 2, 0m, 100, 100, "Iphone test", 0 });
        }
    }
}
