...
export default function createGlobalStyle(styles: TemplateStringsArray, ...interpolations: any[]) {
  return React.memo(() => {
    ...
    document.head.insertBefore(styleElement, findLastStyleTag()?.nextSibling as any);
