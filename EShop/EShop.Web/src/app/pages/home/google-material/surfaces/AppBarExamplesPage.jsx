    ...
    <>
      ...
      <div className='row'>
        <div className='col-md-6'>
          <CodeExample jsCode={jsCode1} beforeCodeTitle='App Bar with buttons'>
        ...
        <div className='col-md-6'>
          <CodeExample jsCode={jsCode2} beforeCodeTitle='Simple App Bar'>
            <div className='kt-section'>
              <span className='kt-section__sub'></span>
              <div className='kt-section__content'>
      ...
      <div className='row'>
        <div className='col-md-6'>
          ...
          >
            <div className='kt-section'>
              <span className='kt-section__sub'>A primary searchbar.</span>
        ...
        <div className='col-md-6'>
          <CodeExample jsCode={jsCode4} beforeCodeTitle='App Bar with menu'>
            <div className='kt-section'>
              <span className='kt-section__sub'></span>
              <div className='kt-separator kt-separator--dashed'></div>
              <div className='kt-section__content'>
      ...
      <div className='row'>
        <div className='col-md-6'>
          ...
          >
            <div className='kt-section'>
              <span className='kt-section__sub'>A side searchbar.</span>
              <div className='kt-separator kt-separator--dashed'></div>
              <div className='kt-section__content'>
        ...
        <div className='col-md-6'>
          <CodeExample jsCode={jsCode6} beforeCodeTitle='Dense (desktop only)'>
            <div className='kt-section'>
              <span className='kt-section__sub'></span>
              <div className='kt-section__content'>
